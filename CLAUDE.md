...
The oracle comparison has **5,598 passing episodes out of ~6,601 oracle** (~85%). Oracle episodes are generated by the C# ink runtime (`tools/ink-oracle/`). The ratchet is at 5,598. 390 cases total, 358 pass / 6 fail; 1,006 episode mismatches, 0 missing.
