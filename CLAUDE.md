...
The oracle comparison has **5,574 passing episodes out of 6,601 oracle** (84%). Oracle episodes are generated by the C# ink runtime (`tools/ink-oracle/`). The ratchet is at 5,574.
