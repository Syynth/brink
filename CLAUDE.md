...
The oracle comparison has **3,544 passing episodes out of 6,561 oracle** (54%). Oracle episodes are generated by the C# ink runtime (`tools/ink-oracle/`). The ratchet is at 3,540.
