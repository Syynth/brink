...
The oracle comparison has **3,526 passing episodes out of 6,561 oracle** (53%). Oracle episodes are generated by the C# ink runtime (`tools/ink-oracle/`). The ratchet is at 3,525.
