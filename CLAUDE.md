...
The oracle comparison has **5,607 passing episodes out of ~6,615 oracle** (~85%). Oracle episodes are generated by the C# ink runtime (`tools/ink-oracle/`). The ratchet is at 5,607. 396 cases total, 365 pass / 7 fail; 1,008 episode mismatches, 0 missing.
