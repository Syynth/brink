...
The oracle comparison has **5,607 passing episodes out of ~6,619 oracle** (~85%). Oracle episodes are generated by the C# ink runtime (`tools/ink-oracle/`). The ratchet is at 5,607. 397 cases total, 365 pass / 8 fail; 1,010 episode mismatches, 2 missing. (The case/mismatch/missing totals moved from 396/7/1,008/0 with the 2026-07-28 `tests/tier1/includes/root-weave-in-entry-and-included-file` fixture, #1504 — it compiles now but still fails 0/4 episodes on the pre-existing root-content-splice divergence also recorded at `tier3/includes/choice-accumulation-across-include` and `tier3/includes/root-content-splice-site`. The ratcheted episode-pass count itself is unchanged at 5,607.)
