...
The oracle comparison has **5,577 passing episodes out of ~6,601 oracle** (84%). Oracle episodes are generated by the C# ink runtime (`tools/ink-oracle/`). The ratchet is at 5,577. 390 cases total, 350 pass / 14 fail; 1,027 episode mismatches, 0 missing.
