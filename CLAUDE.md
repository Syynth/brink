...
The oracle comparison has **5,250 passing episodes out of 6,601 oracle** (79.5%). Oracle episodes are generated by the C# ink runtime (`tools/ink-oracle/`). The ratchet is at 5,250.
...
Active work is on **compiler + runtime conformance** — closing the remaining gap to the oracle. 388 cases total, 346 pass / 15 fail; 391 episode mismatches + 960 missing episodes. Remaining failures cluster in the compiler's HIR/LIR lowering and codegen correctness.
