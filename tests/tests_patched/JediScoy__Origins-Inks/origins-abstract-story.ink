VAR ArrakisEpisodeFive = false
VAR ArrakisEpisodeFour = false
VAR ArrakisEpisodeOne = false
VAR ArrakisEpisodeThree = false
VAR ArrakisEpisodeTwo = false
VAR Hutton = false
VAR Lyell = false
VAR Maid = false
VAR O0EpisodeFive = false
VAR O0EpisodeFour = false
VAR O0EpisodeOne = false
VAR O0EpisodeThree = false
VAR O0EpisodeTwo = false
VAR O1EpisodeFive = false
VAR O1EpisodeFour = false
VAR O1EpisodeOne = false
VAR O1EpisodeThree = false
VAR O1EpisodeTwo = false
VAR O2EpisodeFive = false
VAR O2EpisodeFour = false
VAR O2EpisodeOne = false
VAR O2EpisodeThree = false
VAR O2EpisodeTwo = false
VAR O3EpisodeFive = false
VAR O3EpisodeFour = false
VAR O3EpisodeOne = false
VAR O3EpisodeThree = false
VAR O3EpisodeTwo = false
VAR O4EpisodeFive = false
VAR O4EpisodeFour = false
VAR O4EpisodeOne = false
VAR O4EpisodeThree = false
VAR O4EpisodeTwo = false
VAR O5EpisodeFive = false
VAR O5EpisodeFour = false
VAR O5EpisodeOne = false
VAR O5EpisodeThree = false
VAR O5EpisodeTwo = false
VAR O6EpisodeFive = false
VAR O6EpisodeFour = false
VAR O6EpisodeOne = false
VAR O6EpisodeThree = false
VAR O6EpisodeTwo = false
VAR SeasonArrakis = false
VAR SeasonO0 = false
VAR SeasonO1 = false
VAR SeasonO2 = false
VAR SeasonO3 = false
