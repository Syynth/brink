...
VAR player_item_candle_arthur = false
VAR player_item_candle_beau = false
VAR player_item_candle_cerise = false
VAR player_item_candle_destin = false
VAR player_item_candle_erzulie = false
VAR player_item_candle_fortigan = false
VAR player_item_candle_gawain = false
VAR player_item_memory_of_chains = false
VAR player_item_stained_soul = false
VAR player_item_weeping_scars = false
