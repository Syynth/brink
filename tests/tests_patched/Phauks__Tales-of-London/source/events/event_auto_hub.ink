...
VAR event_festival_august = false
VAR event_festival_december = false
VAR event_festival_february = false
VAR event_festival_january = false
VAR event_festival_july = false
VAR event_festival_may = false
VAR event_festival_october = false
VAR event_gains_anatomy = false
VAR event_gains_artisan = false
VAR event_gains_chess = false
VAR event_gains_dangerous = false
VAR event_gains_discordance = false
VAR event_gains_glasswork = false
VAR event_gains_mithridacy = false
VAR event_gains_persuasive = false
VAR event_gains_shadowy = false
VAR event_gains_shapeling = false
VAR event_gains_toxicology = false
VAR event_gains_watchful = false
VAR event_gains_zeefaring = false
VAR event_posi = false
VAR event_smen_candle_arthur = false
VAR event_smen_candle_beau = false
VAR event_smen_candle_cerise = false
VAR event_smen_candle_destin = false
VAR event_smen_candle_erzulie = false
VAR event_smen_candle_fortigan = false
VAR event_smen_candle_gawain = false
VAR event_smen_indefinite_reckoning = false
VAR event_smen_memory_of_chains = false
VAR event_smen_stained_soul = false
VAR event_smen_weeping_scars = false
VAR event_smen_well = false
VAR player_anatomy = false
VAR player_artisan = false
VAR player_chess = false
VAR player_dangerous = false
VAR player_discordance = false
VAR player_glasswork = false
VAR player_item_breath_void = false
VAR player_item_fluke_core = false
VAR player_item_impossible_theorem = false
VAR player_item_masters_blood = false
VAR player_item_reported_location = false
VAR player_item_rumourmongers_network = false
VAR player_item_tasting_flight = false
VAR player_item_veils_velvet = false
VAR player_mithridacy = false
VAR player_persuasive = false
VAR player_shadowy = false
VAR player_shapeling = false
VAR player_smen = false
VAR player_toxicology = false
VAR player_watchful = false
VAR player_zeefaring = false
VAR timer_month = false
VAR timer_week = false
=== auto_fire_events ===
