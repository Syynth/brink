VAR beautystand_find_pinklady = false
VAR bobatea_find_dukedelicious = false
VAR consoles_start_aplequest = false
VAR fountain_findfather = false
VAR weirdtree_findgranny = false
== wertoys ==
