VAR drinkCount = 0
VAR currentWorld = "real"
VAR visited_bobatea_real = false
VAR visited_bobatea_dream = false

== bobatea ==

    {
        - currentWorld == "dream" && visited_bobatea_real:
            -> bobatea_realvisited
            
        - currentWorld == "dream":
            -> bobatea_dream
            
        - currentWorld == "real" && visited_bobatea_dream:
