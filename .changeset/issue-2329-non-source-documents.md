...
Also fixed `has_recognized_source_extension`/`file_language`'s
case-sensitive extension comparison (`.INK` was invisible to the source-file
check on a case-insensitive filesystem) — extension matching is now
