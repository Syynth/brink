...
// ─── Structs (E068–E071, E073, E074, E083) ───────────────────────────
...
#[test]
fn e083_duplicate_field_under_gradual() {
    ...
    assert_error_at(&source, brink_options(), DiagnosticCode::E083, "x: 2.0");
}

#[test]
fn e083_duplicate_field_under_strict() {
    let source = format!("{POINT_SRC}~ temp p = Point#{{x: 1.0, x: 2.0, y: 3.0}}\nHi\n");
    assert_error_at(&source, strict_options(), DiagnosticCode::E083, "x: 2.0");
}
