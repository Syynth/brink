...
| Conflict view, breakage/boundary editing | parity gap | `conflict-view.ts`, `breakage.ts`, `boundary.ts`. Rename already carries the ruled breakage report; these are the rest. |
