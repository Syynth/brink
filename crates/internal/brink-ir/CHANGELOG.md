...
## [0.0.17](https://github.com/Syynth/brink/compare/brink-ir-v0.0.16...brink-ir-v0.0.17) - 2026-09-12
...
- *(gpui)* say the suppression rule correctly — not an error, rather
- add the left-operand-fold superinstructions, bump .inkb to v9
- add the binary-fusion superinstructions, bump .inkb to v8
- regenerate the debug-info-off golden hashes for .inkb v7
