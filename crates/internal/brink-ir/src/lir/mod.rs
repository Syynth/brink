...
pub use lower::{
    AnalyzerTables, CoalesceLookup, CoalesceShape, LirPrelude, PreludeDecls, ScopeChunk,
    StructShapeData, TypeMode, UfcsLookup, UfcsVerdict, assemble_prelude, assemble_program,
    build_prelude, build_prelude_decls, build_struct_shape_data, lower_knot_chunk_incremental,
