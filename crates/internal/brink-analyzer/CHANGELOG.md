...
## [0.0.12](https://github.com/Syynth/brink/compare/brink-analyzer-v0.0.11...brink-analyzer-v0.0.12) - 2026-08-23
...
- *(brink-analyzer)* frame-scope temp shape/reassignment tracking, fold ref-out rebinds in, stop redeclaration from erasing reassignment history
...
- *(analyzer)* resolve bare list items in RefKind::Function refs ([#2830](https://github.com/Syynth/brink/pull/2830))
...
- Merge branch 'main' into auto/issue-2298
- Review-fix round for #2298: honest hint wording, pinned Constant shadow order, clean fixtures
- Fix #2298: close the module-qualified-import remainder #2287/#2296 left
- Address review findings: rustfmt, E188.md suppression channels, verbatim quotations
- ConventionsProjection carries !name dispatch handler rows ([#2352](https://github.com/Syynth/brink/pull/2352))
- Address review findings: call-through phrasing for FieldCall arg mismatches, pin index convention in test, E063.md producer list
...
- *(analyzer)* pin proptest completeness counterexample (issue #2830)
- Merge branch 'main' into auto/issue-2793
- pin actual E063 fallout for #2793's coalesce/contains findings
- audit BodyTypes::locals consumers for #2786 annotated-param visibility ([#2793](https://github.com/Syynth/brink/pull/2793))
- Merge remote-tracking branch 'origin/main' into HEAD
- Pin the two non-diagnostic behavior changes and the untested consumers ([#2773](https://github.com/Syynth/brink/pull/2773))
- Apply review findings: spec-doc the CHECK-side lambda-frame rule, cover the expr-body path, collapse the six-way pruned_locals_for_lambda copy-paste
- Fix bare-name-keyed locals shadowing hazard for lambda-descending analyzer walkers
- fix fn-param re-bind hazard in E116 annotation overlay; doc drift
- an annotated `: Option<T>` param now reaches E116 ([#2782](https://github.com/Syynth/brink/pull/2782))
- fix E116 review findings — exhaustiveness, dedup, root-content global test
- E116 Option-condition walk now visits hir.root_content
- fix E116 lambda-body false positives + close switch-descent gap
- E116 Option-condition walk now descends into lambda block bodies
- Merge branch 'main' into auto/issue-1829
- distinguishability tests for per-attribute E165 ranging + changeset
- give SpanAttr per-attribute provenance so E165 doesn't collapse
- guard unify's pair-match wildcard against future nesting Ty variants
