...
## [0.0.16](https://github.com/Syynth/brink/compare/brink-driver-v0.0.15...brink-driver-v0.0.16) - 2026-08-25

### Added

- *(analysis)* option A total — the off-db monolith is deleted; LSP rides the subset query

## [0.0.15](https://github.com/Syynth/brink/compare/brink-driver-v0.0.11...brink-driver-v0.0.15) - 2026-08-23
