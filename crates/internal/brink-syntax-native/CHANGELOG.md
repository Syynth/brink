...
## [0.0.17](https://github.com/Syynth/brink/compare/brink-syntax-native-v0.0.16...brink-syntax-native-v0.0.17) - 2026-08-29
...
- Record #1638's trailing-comment-in-prose ruling in the spec and test pins
...
- Fix review-blocking findings on #2792 bracket-annotation diagnostic
- Unify the "[ is not the type-argument delimiter" diagnostic ([#2792](https://github.com/Syynth/brink/pull/2792))
- var/const `Option[int]` annotation now fails loudly instead of silently dropping to prose ([#2781](https://github.com/Syynth/brink/pull/2781))
- address review findings on #2775 lambda-generic tests
