...
## [0.0.17](https://github.com/Syynth/brink/compare/brink-ide-v0.0.16...brink-ide-v0.0.17) - 2026-09-12

### Added

- *(gpui)* the Player, the Program Explorer, navigation and fixes in the native studio ([#3580](https://github.com/Syynth/brink/pull/3580))
- *(ide)* the teach-by-example dialect inference and the [dialogue] section writer, in Rust
...
- Merge remote-tracking branch 'origin/main' into claude/gpui-desktop-app-e8jb90
- *(ide)* the diagnostic registry and its category table live in brink-ide
- Merge remote-tracking branch 'origin/main' into claude/gpui-desktop-app-e8jb90
- *(ide)* move the Program Explorer's model and size report down
- *(ide)* move brink.toml application down to the session layer
- *(ide)* move the draft rule down to the session layer
...
- Referrer-scope E061 and register RefKind::Type for param/return annotations
