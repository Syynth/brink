 ...
 * palette command opens at `project`, the Binder's `brink.toml` row at
 * `project`, and the Problems panel's "Configure Exxx…" at `diagnostics`.
...
export const DEFAULT_SETTINGS_SECTION: string = SETTINGS_SECTION_IDS.project;
