...
- b1e1086: `mountStudio` takes a `settingsSections` option: host-provided sections
...
- adcaa6c: Settings: the Player font-size knob does something now.
...
- 7afcd7f: Player: tabbing away from the Player tab and back no longer replays the arrival
