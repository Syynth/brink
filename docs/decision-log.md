...
- **OPEN:** whether the OTA archive reuses the updater's minisign keypair or gets its own. Recommendation is a distinct key (separable trust domains, independent rotation) against one fewer secret to manage.
