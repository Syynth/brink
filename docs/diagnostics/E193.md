...
- [`E194`](E194.md) — the compat-deny sibling this page's shape 4 split off
  into (issue #3373): a stitch reading a temp declared at its knot's root,
  which fires unconditionally rather than by dominance because inklecate
